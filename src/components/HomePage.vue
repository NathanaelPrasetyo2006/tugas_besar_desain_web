<template>
  ...
  <p class="text-center text-2xl text-gray-700 max-w-3xl mx-auto mt-10">
  ...
  >
    <div class="flex items-center gap-10">
      <div
        class="flex flex-col items-center justify-center bg-wgite shadow-xl rounded-2xl w-96 h-64 px-12 py-8"
      >
        <div class="relative">
          <StarIcon class="w-20 h-20 text-yellow-400 animate-pulse drop-shadow-lg" />
          <div
            class="absolute inset-0 bg-linear-to-r from-transparent via-white/60 to-transparent animate-shine rounded-full"
          ></div>
        </div>
        <p class="text-4xl font-bold mt-3">{{ displayedRating.toFixed(1) }}</p>
        <p class="text-gray-600 text-sm mt-1">Rating</p>
      </div>
      <div
        class="flex flex-col items-center justify-center bg-white shadow-xl rounded-2xl w-96 h-64 px-12 py-8"
      >
        <UsersIcon class="w-16 h-16 text-blue-500 drop-shadow-sm" />
        <p class="text-4xl dont-bold mt-3">{{ formattedBuyers }}</p>
        <p class="text-gray-600 text-sm mt-1">Total Buyers</p>
      </div>
    </div>
  </section>
  <p class="text-center text-xl text-gray-600 max-w-2xl mx-auto my-6">
